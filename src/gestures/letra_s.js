...
// Pulgar
letraSDescripction.addCurl(Finger.Thumb, FingerCurl.HalfCurl, 1);
letraSDescripction.addCurl(Finger.Thumb, FingerCurl.HalfCurl, 1);
...
letraSDescripction.addDirection(Finger.Thumb, FingerDirection.VerticalUp, 0.5);
...
for (let finger of [Finger.Index, Finger.Middle, Finger.Ring, Finger.Pinky]){
    ...
    letraSDescripction.addDirection(finger, FingerDirection.VerticalUp, 1);
}
